...
typedef void(^NetPingResultHandler)(PhoneNetPingStatus status, NSString *_Nullable pingres);

#pragma mark -tracert callback
typedef void(^NetTracerouteResultHandler)(Enum_Traceroute_Status status,NSString *_Nullable tracertRes);
